        ...
        <section className="flex w-full h-[500px]">
            <div className="flex justify-center items-center w-[70%] bg-[#29A841]">
                ...
                <h3 className="text-white">www.megamart.com</h3>
                    <div className="grid grid-cols-2 gap-1 sm:ml-[150px] max-[640px]:ml-[80px]">
                    <button className="text-[#29A841]  font-semibold max-[640px]:w-[100px] mt-5 w-[150px] h-[50px] border-4 border-[#FFD600] bg-white rounded-full">SHOP AGAIN</button>
                    </div>
                </div>
            </div>
