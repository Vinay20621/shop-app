...
export default function beautyCarousel({ items }) {
  ...
  return (
    <div className="bg-[url('Rectangle_248.png')] bg-no-repeat bg-cover w-full pl-5 pr-5 flex-1 justify-between items-center">
      <div className="flex overflow-hidden justify-center">
        ...
        >
          {getVisibleItems().map((item, index) => (
            ...
            >
              <BeautyCard title={item.title} imageSrc={item.imageSrc} altText={item.title} />
